...
G = nx.read_gpickle("../Test/Sicilia/5Novembre/grafoSicilia5Novembre.pickle")

print len(G.nodes())

with open('../Test/Sicilia/5Novembre/dizionarioPolarizzazioneRandomWalk.pickle', "rb") as input:
    labelPol = pickle.load(input)
with open('../Test/Sicilia/5Novembre/listaColoriPolarizzazioneRandomWalk.pickle', "rb") as input:
