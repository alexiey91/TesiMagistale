...
vector_dim = 300
root_path = "/home/alessandro/PycharmProjects/Tesi/SemanticSearch/"
...
def gensim_demo():
    ...
    #
    filename='RegionaliSicilia.txt'
    sentences = word2vec.Text8Corpus((root_path + filename))
    logging.basicConfig(format='%(asctime)s : %(levelname)s : %(message)s', level=logging.INFO)
    model = word2vec.Word2Vec(sentences, iter=10, min_count=1, size=300, workers=4)

    print (model.most_similar('Cinque'))


    # # get the word vector of "the"
    # print(model.wv['#berlusconi'])
    #
    ...
    # print('Index of "of" is: {}'.format(model.wv.vocab['sicilia'].index))
