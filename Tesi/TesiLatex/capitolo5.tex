...
\begin{figure}[h!]
    \begin{center}
      \includegraphics[scale= 0.45]{Flusso.png}
...
Prima di popolare il grafo sono state effettuate tutte le precedenti operazioni. Per la realizzazione del grafo è stata utilizzata la libreria \textbf{Networkx}\footnote{NetworkX è una libreria Python per la creazione, manipolazione e studio delle strutture, dinamiche, e delle funzioni di una rete complessa.}, scritta in \textit{Python}.
