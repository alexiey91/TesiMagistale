...
def mergeProbDicPartition(hashtag,color):
    probFull={}
...
def main():
    print()
    hashtags = ['EleSicilia', 'elezionisicilia2017', 'elezionisicilia', 'regionalisicilia2017']
    colors = ['Blue','Red','Yellow']

    retweetListAllBlue = mergeListPartition(hashtags,colors[0])
    ...
    retweetListAllRed = mergeListPartition(hashtags,colors[1])
    ...
    retweetListAllYellow = mergeListPartition(hashtags, colors[2])
