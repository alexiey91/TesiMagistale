...
#     with open('./pickle/EutanasiaTestAWS/tweet' + query + '_' + start + '_' + stop + '_dictionaryReTweet'+char+'.pkl', 'wb') as output:
...
def retweetmain(readList, query, start, stop,dizionario_tweet,char):
    ...
    with open('./pickle/EutanasiaTestAWS/retweet'+char+ query + '_' + start + '_' + stop + '_data.pkl', 'wb') as output:
        pickle.dump(result, output, pickle.HIGHEST_PROTOCOL)
    # getRetweet(api,readList,len(readList),list_ret,query,start,stop);
    print('finito getRetweet')
    with open('./pickle/EutanasiaTestAWS/retweet'+char + query + '_' + start + '_' + stop + '_data.pkl', 'rb') as input:
...
def main():
    ...
    dizionario_hashtag = {}
    with open('../utils/ListaHashtagEutanasia.txt', 'r') as fileHashtags:
    ...
    for t in range(len(tweet)):
        ...
        if len(b3)==0:
            ...
            if(sentiment.checkPartition(u._unidecode(tweet[t].text).lower()) == "Blue"):
            ...
            elif(sentiment.checkPartition(u._unidecode(tweet[t].text).lower()) == "Red"):
    ...
    with open('./pickle/EutanasiaTestAWS/tweetBlue' + query + '_' + start + '_' + stop + '_data.pkl', 'wb') as output:
        pickle.dump(listBlue, output, pickle.HIGHEST_PROTOCOL)

    with open('./pickle/EutanasiaTestAWS/tweetBlue' + query + '_' + start + '_' + stop + '_dictionaryTweet.pkl', 'wb') as output:
        pickle.dump(dizionario_tweet_Blue, output, pickle.HIGHEST_PROTOCOL)

    with open('./pickle/EutanasiaTestAWS/tweetRed' + query + '_' + start + '_' + stop + '_data.pkl', 'wb') as output:
            pickle.dump(listRed, output, pickle.HIGHEST_PROTOCOL)

    with open('./pickle/EutanasiaTestAWS/tweetRed' + query + '_' + start + '_' + stop + '_dictionaryTweet.pkl', 'wb') as output:
            pickle.dump(dizionario_tweet_Red, output, pickle.HIGHEST_PROTOCOL)

    # with open('./pickle/EutanasiaTestAWS/tweetYellow' + query + '_' + start + '_' + stop + '_data.pkl', 'wb') as output:
    #         pickle.dump(listYellow, output, pickle.HIGHEST_PROTOCOL)
    # 
    # with open('./pickle/EutanasiaTestAWS/tweetYellow' + query + '_' + start + '_' + stop + '_dictionaryTweet.pkl', 'wb') as output:
    #         pickle.dump(dizionario_tweet_Yellow, output, pickle.HIGHEST_PROTOCOL)

    with open('./pickle/EutanasiaTestAWS/tweetAll' + query + '_' + start + '_' + stop + '_data.pkl', 'wb') as output:
        pickle.dump(list, output, pickle.HIGHEST_PROTOCOL)

    with open('./pickle/EutanasiaTestAWS/tweetAll' + query + '_' + start + '_' + stop + '_dictionaryTweet.pkl',
              'wb') as output:
