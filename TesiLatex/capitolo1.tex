...
Otteniamo  la formazione degli \textit{Echo-Chambers}, definiti come:
\begin{quote} 
...
\begin{itemize}
\item \textbf{\textit{Measuring Political Polarization: Twitter shows the two sides of Venezuela}}\cite{morales2015polarization}:
...
\item \textbf{\textit{Reducing Controversy by Connecting Opposing Views}}\cite{Garimella2015polarization}:
